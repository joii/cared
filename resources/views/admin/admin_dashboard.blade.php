...
<html lang="en">
    ...
    <head>
        ...
        @if (request()->routeIs('backend.pawn_transaction.index','backend.reports.*','backend.customer.*','backend.pawn_add.*'))
        <!-- flatpickr css -->
    ...
    <!-- <body data-layout="horizontal"> -->
        ...
        @if (request()->routeIs('backend.branch.index','backend.interest_rate.index','backend.bank_account.index','backend.faq_category.index','backend.faqs.index','backend.banner.index','backend.gold_price.index','backend.pawn_transaction.index','backend.reports.*','backend.customer.*','backend.pawn_add.*'))
        ...
        @if (request()->routeIs('backend.customer.*'))
        <!-- flatpickr js -->
        <script src="{{ asset('backend/assets/libs/flatpickr/flatpickr.min.js')}}"></script>
