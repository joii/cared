        ...
        <div class="d-flex">
            ...
            <div class="navbar-brand-box">
                <a href="{{  route('admin.dashboard') }}" class="logo logo-dark">
                    <span class="logo-sm">
                        <img src="{{ asset('backend/assets/images/logo-sm.svg')}}" alt="Care.D - Nursing Home" height="24">
                    </span>
                    <span class="logo-lg">
                        <img src="{{ asset('backend/assets/images/logo-sm.svg')}}" alt="Care.D - Nursing Home" height="24"><span class="logo-txt">Care.D</span>
                    </span>
                </a>
                    ...
                    <form class="p-3">
                        <div class="form-group m-0">
                            <div class="input-group">
                                <input type="text" class="form-control" placeholder="ค้นหา ..." aria-label="ผลการค้นหา">
            ...
            <div class="dropdown d-none d-lg-inline-block ms-1">
                ...
                <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end">
                    <div class="p-2">
                        <div class="row g-0">
                            <div class="col">
                                <a class="dropdown-icon-item" href="https://github.com/" target="_blank">
                                    <img src="{{ asset('backend/assets/images/brands/github.png')}}" alt="Github">
                                    <span>GitHub</span>
                                </a>
                            </div>
                            <div class="col">
                                <a class="dropdown-icon-item" href="https://search.google.com/test/rich-results" target="_blank">
                                    <img src="{{ asset('backend/assets/images/brands/google.png')}}" alt="Google Rich Result">
                                    <span>Google Rich Result</span>
                                </a>
                            </div>
                           <div class="col">
                                <a class="dropdown-icon-item" href="https://slack.com/" target="_blank">
