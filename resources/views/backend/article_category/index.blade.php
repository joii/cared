                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header" style="text-align: right;">
                                <a href="{{ route('backend.article_category.create') }}" class="btn btn-success" >Add New</a>
                            </div>
                            ...
                            <div class="card-body">
                                ...
                                <table id="datatable" class="table table-bordered dt-responsive  nowrap w-100">
                                    ...
                                    <tr>
                                        ...
                                        <th><a href="{{ route('backend.article_category.edit',$item->id) }}" class="btn btn-outline-danger">Edit</a></th>
                                    </tr>
                                    @endforeach
