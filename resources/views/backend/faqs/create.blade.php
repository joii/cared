    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-xl-12">
                <div class="card">
                    <div class="card-body">
                        <form id="myForm" action="{{ route('backend.faqs.store') }}" method="post" >
                            @csrf
                            <div class="row">
                                <div class="col-lg-12">
                                    <div>
                                ...
                                <div class="col-lg-12">
                                    <div>
                                        <div class="form-group mb-3">
                                            ...
                                            <input class="form-control" type="text" name="question_th"  id="question_th" required>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-lg-12">
                                    <div>
                                        <div class="form-group mb-3">
                                            ...
                                            <textarea class="summernote" name="answer_en"></textarea>
                                        </div>
                                ...
                                <div class="col-lg-12">
                                    <div>
                                        <div class="form-group mb-3">
                                            ...
                                            <textarea class="summernote" name="answer_th"></textarea>
                                        </div>
