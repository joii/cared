                        ...
                        <form class="needs-validation " novalidate="" action="{{ route('backend.gtm.store') }}" method="POST">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="mb-3">
                                        <label class="form-label" for="gtm_first_block">GTM First Block paste it as high in the head tag</label>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label class="form-label" for="gtm_second_block">GTM Second Block paste it immediately after the opening body tag </label>
