        ...
        <div class="row">
            <div class="col-xl-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form id="myForm" action="{{ route('backend.testimonials.store') }}" method="post" enctype="multipart/form-data" >
                            @csrf
                            <div class="row">
                                <div class="col-lg-12">
                                    <div>
                                ...
                                <div class="col-lg-12">
                                    <div>
                                        <div class="form-group mb-3">
                                            ...
                                            <input class="form-control" type="text" name="branch_en"  id="branch_en" required>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-lg-12">
                                    <div>
                                        <div class="form-group mb-3">
                                            ...
                                            <input class="form-control" type="text" name="branch_th"  id="branch_th" required>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-lg-12">
                                    <div>
                                        <div class="form-group mb-3">
                                            ...
                                            <textarea class="form-control" name="description_th" id="description_th" required></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
